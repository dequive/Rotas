...
def test_f02_trip_lifecycle_operations_have_explicit_success_schemas() -> None:
    ...
    operations = {
        ...
        ("post", "/api/v1/trips/{trip_id}/costs"),
        ("get", "/api/v1/trips/{trip_id}/costs"),
        ("post", "/api/v1/trips/{trip_id}/costs/{cost_id}/corrections"),
...
def test_driver_and_sync_operations_have_explicit_public_contracts() -> None:
    ...
    successful_operations = {
        ...
        ("get", "/api/v1/driver/records/checklists"),
        ("get", "/api/v1/driver/records/fuel"),
        ("get", "/api/v1/driver/records/expenses"),
        ("get", "/api/v1/driver/records/advances"),
