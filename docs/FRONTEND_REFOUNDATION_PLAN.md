...
| F7.4 | parcial | replay/conflito/escopo por tenant em 15 mutacoes com controlo negativo sem chave (46 testes); conflito de payload de 2 para 17 das 54 operacoes; matriz RBAC de 10 mutacoes x 6 papeis derivada de `ROLE_PERMISSIONS` mais nao autenticado (72 testes) | estender as 37 operacoes idempotentes restantes e alargar a matriz RBAC as transicoes de estado |
