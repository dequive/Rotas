...
DO $$ BEGIN CREATE ROLE rotas_app LOGIN; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE ROLE rotas_admin LOGIN BYPASSRLS; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
ALTER ROLE rotas_app LOGIN;
ALTER ROLE rotas_admin LOGIN;
