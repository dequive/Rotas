...
- [x] 25-03-PLAN.md — Wave 3: require_own_tenant_or_platform() combined guard, tenants/router.py wired, 2 additional isolation tests, Ruff clean
...
- [x] 26-02-PLAN.md — Wave 2: gt02 DML backfill migration (2213 clients → third_parties + roles + client_profiles, batches of 500, idempotent)
- [x] 26-03-PLAN.md — Wave 3: create_client find-or-create rewrite + 3 new GT-05 tests
...
| 26. Gestão de Terceiros — Backend Unification | 3/3 | Complete   | 2026-06-22 |
