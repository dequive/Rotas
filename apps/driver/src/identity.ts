...
/**
 * Revokes the local session first, then removes every operational record and
 * authenticated HTTP/background-sync cache. Any failure leaves the UI locked
 * instead of allowing another driver to pair against residual data.
 */
