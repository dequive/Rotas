...
class PurchaseOrder(Base):
    ...
    __table_args__ = (Index("ix_purchase_orders_tenant_third_party", "tenant_id", "third_party_id"),)
...
class SupplierInvoice(Base):
    ...
    __table_args__ = (Index("ix_supplier_invoices_tenant_third_party", "tenant_id", "third_party_id"),)
    ...
    file_id: Mapped[uuid.UUID | None] = mapped_column(PG_UUID(as_uuid=True), ForeignKey("files.id"), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)
    updated_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), server_default=func.now(), onupdate=func.now(), nullable=False
    )
...
class SupplierPayment(Base):
    ...
    __table_args__ = (Index("ix_supplier_payments_tenant_third_party", "tenant_id", "third_party_id"),)
