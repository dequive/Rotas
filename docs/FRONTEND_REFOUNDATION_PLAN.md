...
| F7.4 | parcial | 158 testes de matriz: replay/conflito/escopo por tenant em 15 mutacoes com controlo negativo sem chave, conflito de payload de 2 para 17 das 54 operacoes, RBAC de 10 mutacoes x 6 papeis derivada de `ROLE_PERMISSIONS`, e 5 transicoes de estado x 6 papeis com prova de estado inalterado, sem token e cross-tenant | estender as 37 operacoes idempotentes restantes e as transicoes de carga e orcamento |
