...
class BaseReportEngine(FPDF):
    ...
    def __init__(self, tenant: Tenant, profile: TenantDocumentProfile | None, title: str = "Documento"):
        ...
        self.set_author(self.profile.legal_name if self.profile and self.profile.legal_name else self.tenant.name)
    ...
    def header(self):
        ...
        self.cell(0, 5, f"NUIT: {nuit} | Contacto: {contact}", border=0, new_x="LMARGIN", new_y="NEXT", align="L")
        
        # Título do Documento à Direita
        self.set_y(15)
        self.set_font("helvetica", "B", 16)
        self.set_text_color(*self.primary_color)
        self.cell(0, 10, self.document_title.upper(), border=0, new_x="LMARGIN", new_y="NEXT", align="R")
